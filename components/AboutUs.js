...
function AboutUs() {
  return (
    <div className='bg-white text-black mt-5 p-4'>
            ...
            <div className=''>
                ...
                <div className='flex justify-between p-2'>
                    <div className='w-[500px]'>
                        ...
                        <p>Bringing dream homes to life with modern designs and durable structures.</p>
                    </div>
                    <div className='w-[500px]'>
                        ...
                        <p>Creating functional and aesthetically pleasing spaces for businesses to thrive.</p>
                    </div>
                </div>
                <div className='flex justify-between p-2'>
                    <div className='w-[500px]'>
