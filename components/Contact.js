...
function Contact() {
  ...
  return (
    <div className='bg-gray-200 p-4 mt-2 rounded-md'>
        <h1 className='text-8xl font-bold mt-5 mb-5 text-[#0E2744] uppercase'>Contact US</h1>
        <div className='flex justify-between items-center'>
            ...
            <div>
                ...
                <div className="ml-5 flex space-x-4 border bg-black w-fit px-2 py-2"> 
                    <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                        <FaFacebookF className="text-white text-2xl hover:scale-110 transition-transform duration-300" />
                    </a>
                    <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
                        <FaLinkedinIn className="text-white text-2xl hover:scale-110 transition-transform duration-300" />
                    </a>
                </div>
            </div>
            <form className='flex flex-col gap-2 border w-1/2'>
                ...
                <textarea className='p-2' value={message}
              onChange={(e) => setMessage(e.target.value)} />
                ...
                <p className='text-sm'>All Rights Reserved copyright@2024</p>
            </form>
        </div>
    </div>  
  )
